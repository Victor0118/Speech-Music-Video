...
////  opencvCFSS
////
////  Created by Victor Young on 12/27/15.
...
//        {
//            cout << "读取视频失败" << endl;
//            showFloatGraph("RotationAngle", &distarray[0], (int)distarray.size());
//            waitKey(0);
//            break;
////            return -1;
//        }
...
//        
//    }
//    showFloatGraph("X2 Histogram", &distarray[0], (int)distarray.size());
//    waitKey(0);
//    IplImage* image = drawFloatGraph(&distarray[0], distarray.size(),0,0.0,0.0,1000);
//    showImage(image,0,"X2 Histogram");
//    //关闭视频文件
//    capture.release();
//    waitKey(0);
//    return 0;
